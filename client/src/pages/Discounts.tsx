      ...
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-mono font-semibold transition-all ${
        isLink
          ...
          : copied
            ...
            : "bg-[#7a9e6e]/15 text-[#5a7a4e] border border-[#7a9e6e]/25 hover:bg-[#7a9e6e]/25 cursor-pointer"
      }`}
  ...
  return (
    <section className="mb-8">
      ...
      >
        ...
        >
          <Icon className="w-5 h-5 text-[#7a9e6e]" />
        </div>
      ...
      >
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div
            ...
            style={{ background: "radial-gradient(circle, #7a9e6e 0%, transparent 70%)", filter: "blur(50px)" }}
          />
        </div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <CategorySection
            ...
            items={healthTech}
            badgeColor="bg-[#8aaa7a]/20 text-[#5a7a4e] border-[#8aaa7a]/30"
