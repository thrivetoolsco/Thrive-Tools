      ...
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-mono font-semibold transition-all ${
        isLink
          ...
          : copied
            ...
            : "bg-[#14b8a6]/15 text-teal-600 border border-teal-500/25 hover:bg-[#14b8a6]/25 cursor-pointer"
      }`}
      ...
      >
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div
            ...
            style={{ background: "radial-gradient(circle, #14b8a6 0%, transparent 70%)", filter: "blur(50px)" }}
          />
        </div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <CategorySection
            ...
            badgeColor="bg-rose-400/20 text-teal-600 border-rose-400/30"
          ...
          <CategorySection
            ...
            items={healthTech}
            badgeColor="bg-teal-400/20 text-teal-600 border-teal-400/30"
