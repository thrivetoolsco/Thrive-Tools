  ...
  return (
    <PageLayout title="Contact">
      <div className="max-w-lg mx-auto text-center space-y-8" data-testid="section-contact">
        <p className="text-white/70 text-lg leading-relaxed" data-testid="text-contact-intro">
        ...
        <div className="card-glass rounded-md p-8 flex flex-col items-center gap-4" data-testid="card-contact-email">
          ...
          <p className="text-white/50 text-sm tracking-widest uppercase font-medium">Drop a line</p>
          <a
            href="mailto:thrivetools.co@gmail.com"
            className="text-[#e8a4b8] hover:text-white transition-colors text-xl font-display font-semibold break-all"
