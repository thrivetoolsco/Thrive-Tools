      ...
      <div className="space-y-12" data-testid="section-thrive2">
        ...
        <div className="card-glass rounded-md p-6 sm:p-8 space-y-4" data-testid="section-intro">
          <p className="text-black/80 leading-relaxed text-base" data-testid="text-intro">
            I'm stoked to invite you to our weekly Docu Evenings. We're diving into <span className="text-[#c94040] font-semibold">THRIVE II: This is What it Takes</span>, and honestly, it's the shift in perspective we all kind of need right now.
          </p>
        </div>
        ...
        <div className="card-glass rounded-md p-6 sm:p-8 space-y-5" data-testid="section-essentials">
          ...
          <div className="flex flex-col items-center gap-4">
            <p className="text-black/80 leading-relaxed text-base" data-testid="text-cost">
              <span className="text-[#c94040] font-semibold">Cost:</span> Free <span className="text-black/50 text-sm">(It's about the community and the conversation).</span>
            </p>
            <p className="text-black/80 leading-relaxed text-base flex items-center gap-2" data-testid="text-duration">
              <Clock className="w-4 h-4 text-[#c94040]" />
              <span><span className="text-[#c94040] font-semibold">Duration:</span> 2h 30m of mind-bending info.</span>
            </p>
            <p className="text-black/80 leading-relaxed text-base flex items-center gap-2" data-testid="text-registration">
              <Mail className="w-4 h-4 text-[#c94040]" />
              <span>
                <span className="text-[#c94040] font-semibold">How to Join:</span> Shoot a quick email to{" "}
                <a
                  href="mailto:thrivetools.co@gmail.com"
                  className="text-[#c94040] underline underline-offset-4 decoration-[#c94040]/40"
        ...
        <div className="card-glass rounded-md p-6 sm:p-8 text-center" data-testid="section-closing">
          <p className="text-[#c94040] font-display text-lg italic" data-testid="text-closing">
