      ...
      <div className="space-y-12" data-testid="section-food-forest">
        ...
        <div className="card-glass rounded-md p-6 sm:p-8 space-y-4" data-testid="section-rates">
          ...
          <div className="space-y-2">
            <p className="text-[#14b8a6] font-semibold" data-testid="text-schedule">
              Starts every Monday in August & September 2022
            </p>
            <p className="text-[#14b8a6] font-semibold" data-testid="text-location">
              Location : Ucluelet, Canada
            </p>
            <p className="text-[#14b8a6] font-semibold" data-testid="text-price-single">
              $260/ person
            </p>
            <p className="text-[#14b8a6] font-semibold" data-testid="text-price-group">
              $200/ person if you're a group of 2 or more
            </p>
            <p className="text-[#14b8a6] font-semibold" data-testid="text-includes">
