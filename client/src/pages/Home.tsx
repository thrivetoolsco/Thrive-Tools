...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf6eb] text-[#3d1a28] overflow-x-hidden">
      ...
      ═══════════════════════════════════════════ */}
      <section className="relative min-h-screen flex items-center overflow-hidden bg-[#fdf6eb]">
          ...
          <div className="relative mb-10">
            ...
            <div
              style={{
                ...
                boxShadow: "0 0 0 8px rgba(253,246,235,1), 0 0 0 9px rgba(201,64,64,0.1)",
                position: "relative",
              }}
            >
            ...
            <div className="relative">
              ...
              <div
                style={{
                  ...
                  boxShadow: "0 24px 60px rgba(61,26,40,0.1), 0 0 0 10px rgba(253,246,235,1), 0 0 0 11px rgba(201,64,64,0.08)",
                  position: "relative",
                }}
              >
                <img src={edenPortrait} alt="Eden" loading="eager" fetchPriority="high"
      ...
      ═══════════════════════════════════════════ */}
      <section className="relative overflow-hidden" style={{ background: "linear-gradient(180deg, #fdf6eb 0%, #f8ece0 50%, #fdf6eb 100%)" }}>
      ...
      ═══════════════════════════════════════════ */}
      <section className="relative overflow-hidden" style={{ background: "#fdf6eb" }}>
        <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 py-20 sm:py-28 lg:py-32">
      ...
      {/* ═══════════════════════════════════════════
          STORY CTA
      ═══════════════════════════════════════════ */}
      <section id="about" className="relative py-20 sm:py-28 px-6 sm:px-10 text-center" style={{ background: "linear-gradient(180deg, #fdf6eb 0%, #f8ece0 50%, #fdf6eb 100%)" }}>
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #f8ece0 0%, #f0e4f5 50%, #f8ece0 100%)" }}
      >
