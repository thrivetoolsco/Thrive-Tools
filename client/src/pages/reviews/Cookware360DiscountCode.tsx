...
const faqs = [
  {
    q: "Does the 360 Cookware discount code expire?",
  ...
  {
    q: "Where do I enter the 360 Cookware discount code?",
    a: "Add your products to the cart on 360cookware.com, go to checkout, and look for the discount-code box. Type THRIVETOOLS exactly as shown (all caps, no spaces) and apply it before you pay.",
  },
  {
    q: "Can I stack discount codes on 360 Cookware?",
    a: "In almost all cases, no. 360 Cookware checkout accepts one discount code per order, like most brands. If you have more than one code, use whichever saves you the most on that order.",
  },
];
...
export default function Cookware360DiscountCode() {
  return (
    <PageLayout
      showShare
      title="360 Cookware Discount Code 2026"
      subtitle="By Eden Laraki | ThriveTools.co"
      seo={{
        title: "360 Cookware Discount Code 2026 | Thrive Tools",
        description:
          "Looking for a 360 Cookware discount code? Use code THRIVETOOLS at checkout on 360cookware.com. Verified for 2026.",
    ...
    >
      <article className="space-y-10">
        ...
        <div className="card-glass rounded-2xl p-6 md:p-8" data-testid="answer-360-cookware-discount-code">
          <p className="text-lg leading-relaxed text-black/80">
            ...
            360cookware.com to save on your order.
          </p>
        </div>
        ...
        <section>
          <SectionHeader
            eyebrow="The code"
            title="360 Cookware discount code"
            description="Use the link below and the code applies automatically, or enter it manually at checkout."
          />
          <div className="card-glass rounded-2xl p-6 md:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5" data-testid="code-360-cookware-discount-code">
            ...
            <a href="https://www.360cookware.com/THRIVETOOLS" target="_blank" rel="noopener noreferrer">
              <Button className="btn-primary rounded-full px-6" data-testid="button-360-cookware-shop">
                Shop 360 Cookware <ExternalLink className="w-4 h-4 ml-2" />
              </Button>
            </a>
          </div>
        </section>
        ...
        <section>
          ...
          <ol className="space-y-4">
            {[
              "Add the 360 Cookware products you want to your cart on 360cookware.com.",
        ...
        <section>
          ...
          <div className="space-y-4">
            {faqs.map((f, i) => (
              <div key={i} className="card-glass rounded-2xl p-6" data-testid={`faq-360-cookware-${i}`}>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link
              ...
              data-testid="link-360-cookware-all-codes"
            >
            ...
            <Link
              ...
              className="card-glass rounded-2xl p-6 block hover:shadow-lg transition-shadow"
              data-testid="link-360-cookware-discount-faq"
            >
        ...
        <div className="card-glass rounded-2xl p-6 md:p-8" data-testid="cta-360-cookware-discount-code">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <p className="font-display text-xl font-bold text-black">Ready to save on 360 Cookware?</p>
              <p className="text-black/60 mt-1">
                Enter <strong className="font-semibold text-black">THRIVETOOLS</strong> in the discount-code box at checkout.
              </p>
            </div>
            <a href="https://www.360cookware.com/THRIVETOOLS" target="_blank" rel="noopener noreferrer">
              <Button className="btn-primary rounded-full px-6" data-testid="button-360-cookware-discount-code">
                Shop 360 Cookware <ExternalLink className="w-4 h-4 ml-2" />
              </Button>
            </a>
          </div>
        ...
        <div className="flex items-start gap-4 card-glass rounded-2xl p-6" data-testid="bio-360-cookware-discount-code">
        ...
        <p className="text-sm text-black/50 leading-relaxed" data-testid="disclosure-360-cookware-discount-code">
