      ...
      <article className="space-y-12">
        ...
        <section data-testid="section-problem">
          ...
          <div className="grid sm:grid-cols-3 gap-5 mt-6">
            ...
            <div className="card-glass rounded-xl p-5">
              <div className="w-10 h-10 rounded-full bg-[#c41230]/20 border border-teal-500/30 flex items-center justify-center mb-3">
        ...
        <section data-testid="section-why-recommend">
          ...
          <div className="space-y-5">
            ...
            <div className="card-glass rounded-xl p-6">
              <div className="flex items-start gap-3 mb-3">
                <div className="w-8 h-8 rounded-full bg-[#c41230]/20 border border-teal-500/30 flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <section data-testid="section-getting-started">
          ...
          <div className="grid sm:grid-cols-2 gap-5 mt-6">
            ...
            <div className="card-glass rounded-xl p-6 border-l-4" style={{ borderLeftColor: "#c41230" }}>
              <div className="flex items-center gap-2 mb-3">
                <Sparkles className="w-4 h-4 text-[#8b0000]" />
                <h3 className="text-[#8b0000] font-bold">Physical Vitality, Liver Support & Cognitive Clarity</h3>
              </div>
              <p className="text-black/60 text-sm leading-relaxed">
