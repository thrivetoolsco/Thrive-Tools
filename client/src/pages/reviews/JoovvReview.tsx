    ...
    >
      <article className="space-y-12">
        ...
        <section data-testid="section-benefits">
          <h2 className="font-display text-2xl font-bold text-white mb-4" data-testid="text-benefits-heading">The Benefits: What's Actually Happening?</h2>
          <div className="space-y-4 text-white/70 leading-relaxed">
            <p>
        ...
        <section data-testid="section-glass-skin">
          <h3 className="font-display text-xl font-bold text-white mb-4" data-testid="text-glass-skin-heading">1. The "Glass Skin" Factor</h3>
        ...
        <section data-testid="section-recovery">
          <h3 className="font-display text-xl font-bold text-white mb-4" data-testid="text-recovery-heading">2. Recovery for the "Weekend Warrior"</h3>
          <div className="card-glass rounded-xl p-5">
            <p className="text-white/70 text-sm leading-relaxed">
        ...
        <section data-testid="section-circadian">
          <h3 className="font-display text-xl font-bold text-white mb-4" data-testid="text-circadian-heading">3. Circadian Rhythm Hack</h3>
          <div className="card-glass rounded-xl p-5">
            <p className="text-white/70 text-sm leading-relaxed">
        ...
        <section data-testid="section-reality-check">
          <h2 className="font-display text-2xl font-bold text-white mb-4" data-testid="text-reality-heading">The Reality Check: The Joovv "Tax"</h2>
          <div className="space-y-4 text-white/70 leading-relaxed">
            <p>
              Let's address the elephant in the room: <span className="text-white/90 font-semibold">The Price.</span>
            </p>
            <p>
            ...
            <div className="card-glass rounded-xl p-5">
              <ul className="space-y-4 text-white/70 text-sm">
                <li>
                  <span className="text-white/90 font-semibold">The "Safety First" Energy:</span> Joovv panels are medical grade and safety certified. Cheap panels often have "flicker" issues or inconsistent wavelengths that can actually stress your eyes.
                </li>
                <li>
                  <span className="text-white/90 font-semibold">Modular Design:</span> You can start with a Mini 3.0 and literally "lego piece" your way up to a full-body wall as your budget grows.
                </li>
                <li>
                  <span className="text-white/90 font-semibold">The App Integration:</span> Tracking your sessions and setting "Wake up" alarms via the app makes it feel like a seamless part of a smart home, not just a clunky lamp.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section data-testid="section-worth-it">
          <h2 className="font-display text-2xl font-bold text-white mb-4" data-testid="text-worth-heading">Is It Worth It?</h2>
        ...
        <section data-testid="section-verdict">
          <h2 className="font-display text-2xl font-bold text-white mb-4" data-testid="text-verdict-heading">The 2026 Verdict</h2>
          <div className="card-glass rounded-2xl p-6 sm:p-8">
            <p className="text-white/70 leading-relaxed">
