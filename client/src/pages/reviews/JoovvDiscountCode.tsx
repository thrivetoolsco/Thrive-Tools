...
const faqs = [
  {
    q: "Does the Joovv discount code expire?",
  ...
  {
    q: "Where do I enter the Joovv discount code?",
    a: "Add your products to the cart on joovv.com, go to checkout, and look for the discount-code box. Type THRIVETOOLS exactly as shown (all caps, no spaces) and apply it before you pay.",
  },
  {
    q: "Can I stack discount codes on Joovv?",
    a: "In almost all cases, no. Joovv checkout accepts one discount code per order, like most brands. If you have more than one code, use whichever saves you the most on that order.",
  },
];
...
export default function JoovvDiscountCode() {
  return (
    <PageLayout
      showShare
      title="Joovv Discount Code 2026"
      subtitle="By Eden Laraki | ThriveTools.co"
      seo={{
        title: "Joovv Discount Code 2026 | Thrive Tools",
        description:
          "Looking for a Joovv discount code? Use code THRIVETOOLS at checkout on joovv.com. Verified for 2026.",
    ...
    >
      <article className="space-y-10">
        ...
        <div className="card-glass rounded-2xl p-6 md:p-8" data-testid="answer-joovv-discount-code">
          <p className="text-lg leading-relaxed text-black/80">
            ...
            joovv.com to save on your order.
          </p>
        </div>
        ...
        <section>
          <SectionHeader
            eyebrow="The code"
            title="Joovv discount code"
            description="Use the link below and the code applies automatically, or enter it manually at checkout."
          />
          <div className="card-glass rounded-2xl p-6 md:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5" data-testid="code-joovv-discount-code">
            ...
            <a href="https://joovv.com" target="_blank" rel="noopener noreferrer">
              <Button className="btn-primary rounded-full px-6" data-testid="button-joovv-shop">
                Shop Joovv <ExternalLink className="w-4 h-4 ml-2" />
              </Button>
            </a>
          </div>
        </section>
        ...
        <section>
          ...
          <ol className="space-y-4">
            {[
              "Add the Joovv products you want to your cart on joovv.com.",
        ...
        <section>
          ...
          <div className="space-y-4">
            {faqs.map((f, i) => (
              <div key={i} className="card-glass rounded-2xl p-6" data-testid={`faq-joovv-${i}`}>
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link
              ...
              data-testid="link-joovv-all-codes"
            >
            ...
            <Link
              ...
              className="card-glass rounded-2xl p-6 block hover:shadow-lg transition-shadow"
              data-testid="link-joovv-review"
            >
              <p className="font-display font-bold text-black">Joovv</p>
              <p className="text-black/60 text-sm mt-1 leading-relaxed">
                My full review of Joovv red light therapy devices.
              </p>
            </Link>
          </div>
        </section>
        ...
        <div className="card-glass rounded-2xl p-6 md:p-8" data-testid="cta-joovv-discount-code">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <p className="font-display text-xl font-bold text-black">Ready to save on Joovv?</p>
              <p className="text-black/60 mt-1">
                Enter <strong className="font-semibold text-black">THRIVETOOLS</strong> in the discount-code box at checkout.
              </p>
            </div>
            <a href="https://joovv.com" target="_blank" rel="noopener noreferrer">
              <Button className="btn-primary rounded-full px-6" data-testid="button-joovv-discount-code">
                Shop Joovv <ExternalLink className="w-4 h-4 ml-2" />
              </Button>
            </a>
          </div>
        ...
        <div className="flex items-start gap-4 card-glass rounded-2xl p-6" data-testid="bio-joovv-discount-code">
        ...
        <p className="text-sm text-black/50 leading-relaxed" data-testid="disclosure-joovv-discount-code">
