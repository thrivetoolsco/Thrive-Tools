...
import heroImg from "@assets/generated_images/im8-supplement-hero.png";
    ...
    >
      <article className="space-y-12">
        <div className="card-glass rounded-2xl overflow-hidden" data-testid="img-hero-im8">
          <img src={heroImg} alt="IM8 Health all-in-one supplement" className="w-full h-auto object-cover" />
        </div>

        <div className="flex flex-wrap gap-3">
          <Badge className="bg-rose-500/15 text-rose-300 border border-rose-500/25 rounded-full px-3 py-0.5 text-xs">
            In-Depth Review
          </Badge>
        ...
        <section data-testid="section-intro">
          <h2 className="font-display text-2xl font-bold text-white mb-4">What Is IM8?</h2>
        ...
        <section data-testid="section-formula">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-display text-2xl font-bold text-white">The Formula Deep Dive</h2>
          </div>

          <div className="card-glass rounded-2xl overflow-hidden mb-8" data-testid="img-formula">
            <img src={ingredientsImg} alt="IM8 supplement ingredients" className="w-full h-auto object-cover" />
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-5 mb-8">
            <div className="card-glass rounded-xl p-5 text-center">
              ...
              <h3 className="text-white font-bold mb-2">75+ Nutrients</h3>
              <p className="text-white/50 text-xs leading-relaxed">Vitamins, minerals, trace elements sourced from whole food extracts</p>
            </div>
            <div className="card-glass rounded-xl p-5 text-center">
              ...
              <h3 className="text-white font-bold mb-2">15B CFU Probiotics</h3>
              <p className="text-white/50 text-xs leading-relaxed">Multi-strain probiotic blend with prebiotic fiber for gut health</p>
            </div>
            <div className="card-glass rounded-xl p-5 text-center">
              ...
              <h3 className="text-white font-bold mb-2">Full Electrolytes</h3>
              <p className="text-white/50 text-xs leading-relaxed">Sodium, potassium, magnesium for optimal hydration & nerve function</p>
            </div>
          </div>

          <div className="space-y-4 text-white/70 leading-relaxed">
            <p>
              What impressed me most is their use of <strong className="text-white/90">methylated B vitamins</strong>. IM8 uses methylcobalamin (B12) and L-5-MTHF (folate) instead of the cheaper synthetic forms that many competitors use. This matters because roughly 40% of people carry MTHFR gene variants that impair their ability to convert synthetic folic acid.
            </p>
            <p>
        ...
        <section data-testid="section-science">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-display text-2xl font-bold text-white">The Science Behind It</h2>
          </div>
          <div className="space-y-4 text-white/70 leading-relaxed">
            <p>
        ...
        <section data-testid="section-verdict">
          ...
          <div className="card-glass rounded-2xl p-6 sm:p-8 text-center">
            ...
            <p className="text-white font-bold text-lg mb-3">The Real Deal</p>
        ...
        <div className="text-center pt-4">
          <Button asChild size="lg" className="bg-rose-500 text-white border-0 rounded-full px-8 text-sm tracking-widest uppercase font-semibold">
            <a href="https://im8health.com/" target="_blank" rel="noopener noreferrer" data-testid="link-im8-shop">
              Get IM8 — Use Code THRIVE8 <ExternalLink className="ml-2 w-4 h-4" />
            </a>
          </Button>
        </div>
      </article>
