    ...
    >
      <article className="space-y-12">
        ...
        <div className="flex flex-wrap gap-3">
          <Badge className="bg-[#7a9e6e]/15 text-[#5a7a4e] border border-[#7a9e6e]/25 rounded-full px-3 py-0.5 text-xs">
            In-Depth Review
          </Badge>
          ...
          <div className="grid sm:grid-cols-3 gap-5 mb-8">
            ...
            <div className="card-glass rounded-xl p-5 text-center">
              <div className="w-12 h-12 rounded-full bg-purple-500/20 border border-purple-500/30 flex items-center justify-center mx-auto mb-3">
                <Heart className="w-5 h-5 text-[#8aaa7a]" />
              </div>
        ...
        <section data-testid="section-science">
          ...
          <div className="card-glass rounded-xl p-5 mt-6 border-l-4" style={{ borderLeftColor: "#7a9e6e" }}>
