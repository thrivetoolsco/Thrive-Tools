    ...
    >
      <article className="space-y-12">
        ...
        <div className="flex flex-wrap gap-3">
          <Badge className="bg-[#14b8a6]/15 text-teal-600 border border-teal-500/25 rounded-full px-3 py-0.5 text-xs">
            In-Depth Review
          </Badge>
        ...
        <section data-testid="section-science">
          ...
          <div className="card-glass rounded-xl p-5 mt-6 border-l-4" style={{ borderLeftColor: "#14b8a6" }}>
