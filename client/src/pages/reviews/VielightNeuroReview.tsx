    ...
    >
      <article className="space-y-12">
        ...
        <div className="flex flex-wrap gap-3">
          <Badge className="bg-[#c9a020]/15 text-[#d4a030] border border-[#c9a020]/25 rounded-full px-3 py-0.5 text-xs">
            Tech Review
          </Badge>
        ...
        <section data-testid="section-personal">
          ...
          <div className="space-y-4 text-black/70 leading-relaxed">
            ...
            <div className="card-glass rounded-xl p-5 my-6">
              <h3 className="text-[#d4a030] font-bold mb-3">Neuro Gamma (40Hz — Focus & Cognition)</h3>
              <p className="text-black/60 text-sm leading-relaxed">
