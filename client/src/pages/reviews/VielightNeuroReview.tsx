    ...
    >
      <article className="space-y-12">
        ...
        <div className="flex flex-wrap gap-3">
          <Badge className="bg-[#f97316]/15 text-[#c45000] border border-[#f97316]/25 rounded-full px-3 py-0.5 text-xs">
            Tech Review
          </Badge>
        ...
        <section data-testid="section-intro">
          <h2 className="font-display text-2xl font-bold text-black mb-4">What Is the Vielight Neuro?</h2>
          <div className="space-y-4 text-black/70 leading-relaxed">
            <p>
              The Vielight Neuro is a transcranial photobiomodulation (PBM) device that uses near-infrared light (810nm wavelength) to stimulate brain cells. It comes in two variants: the <strong className="text-black/90">Neuro Alpha</strong> (10Hz pulsing for meditation and relaxation) and the <strong className="text-black/90">Neuro Gamma</strong> (40Hz pulsing for cognitive performance and focus).
            </p>
            <p>
        ...
        <section data-testid="section-how-it-works">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-display text-2xl font-bold text-black">How It Works</h2>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-5 mb-8">
            <div className="card-glass rounded-xl p-5 text-center">
              ...
              <h3 className="text-black font-bold text-sm mb-2">Near-Infrared Light</h3>
              <p className="text-black/50 text-xs leading-relaxed">Penetrates skull bone to reach cortical brain tissue up to 3cm deep</p>
            </div>
            <div className="card-glass rounded-xl p-5 text-center">
              ...
              <h3 className="text-black font-bold text-sm mb-2">Mitochondrial Boost</h3>
              <p className="text-black/50 text-xs leading-relaxed">Stimulates cytochrome c oxidase to increase ATP production in neurons</p>
            </div>
            <div className="card-glass rounded-xl p-5 text-center">
              ...
              <h3 className="text-black font-bold text-sm mb-2">Neural Regeneration</h3>
              <p className="text-black/50 text-xs leading-relaxed">Promotes neuroplasticity, reduces neuroinflammation & oxidative stress</p>
            </div>
          </div>
        ...
        <section data-testid="section-clinical">
          <div className="flex items-center gap-3 mb-6">
            <FlaskConical className="w-5 h-5 text-[#c45000]" />
          ...
          <div className="card-glass rounded-xl p-5 mt-4 border-l-4" style={{ borderLeftColor: "#f97316" }}>
            <p className="text-black/50 text-xs uppercase tracking-wider mb-2">Scientific Reference</p>
            <p className="text-black/70 text-sm leading-relaxed">
        ...
        <section data-testid="section-personal">
          <div className="flex items-center gap-3 mb-6">
            <User className="w-5 h-5 text-[#c45000]" />
          ...
          <div className="space-y-4 text-black/70 leading-relaxed">
            ...
            <div className="card-glass rounded-xl p-5 my-6">
              <h3 className="text-[#c45000] font-bold mb-3">Neuro Gamma (40Hz — Focus & Cognition)</h3>
              <p className="text-black/60 text-sm leading-relaxed">
        ...
        <section data-testid="section-verdict">
          ...
          <div className="card-glass rounded-2xl p-6 sm:p-8 text-center">
            ...
            <p className="text-black font-bold text-lg mb-3">A Genuine Breakthrough in Brain Health</p>
        ...
        <div className="flex justify-center pt-4">
          <Button asChild size="lg" className="btn-gradient-rose text-white border-0 rounded-full px-8 py-4 text-sm tracking-widest uppercase font-semibold whitespace-normal text-center leading-relaxed h-auto max-w-md">
            <a href="https://www.vielight.com/devices/" target="_blank" rel="noopener noreferrer" data-testid="link-vielight-shop" className="inline-flex items-center justify-center gap-2 flex-wrap">
              Get Vielight — Use Code THRIVETOOLS <ExternalLink className="w-4 h-4 flex-shrink-0" />
            </a>
          </Button>
        </div>
      </article>
