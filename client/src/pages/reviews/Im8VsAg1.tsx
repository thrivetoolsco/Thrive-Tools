    ...
    >
      <article className="space-y-12">
        ...
        <section data-testid="section-gut-health">
          <h2 className="font-display text-2xl font-bold text-black mb-4" data-testid="text-gut-health-heading">1. The Gut Health "Holy Trinity"</h2>
          <div className="space-y-4 text-black/70 leading-relaxed">
            <p>
            ...
            <div className="card-glass rounded-xl p-5 mt-2">
              <h3 className="text-black/90 font-semibold mb-2">The Probiotics:</h3>
            ...
            <div className="card-glass rounded-xl p-5">
              <h3 className="text-black/90 font-semibold mb-2">The Postbiotic Advantage:</h3>
              <p className="text-black/70 text-sm leading-relaxed">
        ...
        <section data-testid="section-stacks">
          <h2 className="font-display text-2xl font-bold text-black mb-4" data-testid="text-stacks-heading">2. Built-in "Stacks" (Save Your Money)</h2>
          <div className="space-y-4 text-black/70 leading-relaxed">
            <p>
            ...
            <div className="card-glass rounded-xl p-5">
              <ul className="space-y-4 text-black/70 text-sm">
                <li>
                  <span className="text-black/90 font-semibold">Joints & Muscles:</span> It includes 1,000mg of MSM for joint comfort; something AG1 completely lacks.
                </li>
                <li>
                  <span className="text-black/90 font-semibold">Heart & Energy:</span> You get 100mg of CoQ10 (compared to AG1's 60mg) for better cellular energy and heart health.
                </li>
                <li>
                  <span className="text-black/90 font-semibold">Hydration:</span> It actually has a dedicated electrolyte complex. No more buying separate hydration packets for your post workout (or post wine) recovery.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section data-testid="section-transparency">
          <h2 className="font-display text-2xl font-bold text-black mb-4" data-testid="text-transparency-heading">3. Radical Transparency</h2>
          <div className="space-y-4 text-black/70 leading-relaxed">
            <p>
        ...
        <section data-testid="section-verdict">
          <h2 className="font-display text-2xl font-bold text-black mb-4" data-testid="text-verdict-heading">The Verdict</h2>
