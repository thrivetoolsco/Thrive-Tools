...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    badgeColor: "bg-[#c41230]/15 text-[#8b0000] border-[#c41230]/25",
  },
  {
        ...
        {blogPosts.map((post) => (
          <Link key={post.id} href={post.href}>
            ...
            >
              ...
              <h2
                className="font-display text-xl sm:text-2xl font-bold text-black mb-3 group-hover:text-[#8b0000] transition-colors"
              ...
              <span className="inline-flex items-center text-[#8b0000] text-sm font-medium group-hover:text-[#8b0000] transition-colors">
