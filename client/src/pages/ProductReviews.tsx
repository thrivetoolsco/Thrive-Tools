...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    badgeColor: "bg-[#c9a020]/15 text-[#c41230] border-[#c9a020]/25",
  },
  {
    ...
    badge: "Tech Review",
    badgeColor: "bg-[#c9a020]/15 text-[#d4a030] border-[#c9a020]/25",
  },
  {
    id: "hyperion-herbs",
        ...
        {blogPosts.map((post) => (
          <Link key={post.id} href={post.href}>
            ...
            >
              ...
              <h2
                className="font-display text-xl sm:text-2xl font-bold text-black mb-3 group-hover:text-[#c41230] transition-colors"
              ...
              <span className="inline-flex items-center text-[#d4a030] text-sm font-medium group-hover:text-[#c41230] transition-colors">
