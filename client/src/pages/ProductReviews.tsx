...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    badgeColor: "bg-[#c94040]/15 text-[#c41230] border-[#c94040]/25",
  },
  {
        ...
        {blogPosts.map((post) => (
          <Link key={post.id} href={post.href}>
            ...
            >
              ...
              <span className="inline-flex items-center text-[#c41230] text-sm font-medium group-hover:text-[#c41230] transition-colors">
