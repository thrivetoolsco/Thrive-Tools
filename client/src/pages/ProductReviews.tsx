...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    badgeColor: "bg-[#8aaa7a]/15 text-[#5a7a4e] border-[#8aaa7a]/25",
  },
  {
        ...
        {blogPosts.map((post) => (
          <Link key={post.id} href={post.href}>
            ...
            >
              ...
              <span className="inline-flex items-center text-[#5a7a4e] text-sm font-medium group-hover:text-[#5a7a4e] transition-colors">
