...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    badgeColor: "bg-[#7a9e6e]/15 text-[#5a7a4e] border-[#7a9e6e]/25",
  },
  {
    ...
    badge: "Tech Review",
    badgeColor: "bg-[#7a9e6e]/15 text-[#8aaa7a] border-[#7a9e6e]/25",
  },
  {
    id: "hyperion-herbs",
        ...
        {blogPosts.map((post) => (
          <Link key={post.id} href={post.href}>
            ...
            >
              ...
              <h2
                className="font-display text-xl sm:text-2xl font-bold text-black mb-3 group-hover:text-[#5a7a4e] transition-colors"
              ...
              <span className="inline-flex items-center text-[#8aaa7a] text-sm font-medium group-hover:text-[#5a7a4e] transition-colors">
